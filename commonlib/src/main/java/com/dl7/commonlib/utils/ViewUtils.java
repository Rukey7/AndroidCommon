...
public class ViewUtils {
     ...
     * 缩放视图
     */
    public static void zoomViewByDistance(View view, float start, float end) {
        view.setScaleX(start / end);
        view.setScaleY(start / end);
    }

    public static void moveViewX(View view, float distance) {
        view.setTranslationX(distance);
    }

    public static void moveViewX(View view, float start, float end, float space) {
        float distance = space * (start / end);
        moveViewX(view, distance);
    }

    public static void moveViewY(View view, float distance) {
        view.setTranslationY(distance);
    }

    public static void moveViewY(View view, float start, float end, float space) {
        float distance = space * (start / end);
        moveViewY(view, distance);
    }

    /**
     * 设置视图透明度
     * @param view  视图
     * @param percent   百分比，0：全透明；1：不透明
     */
    public static void alphaView(View view, float percent) {
        int alpha = (int) (255 * percent);
        view.getBackground().setAlpha(alpha);
    }

    public static void alphaView(View view, float start, float end) {
        alphaView(view, start / end);
    }
}
