...
//        view.setHasFixedSize(true);
     ...
     * @param view
     */
    public static void initRecyclerViewGH(Context context, RecyclerView view, boolean isDivided,
                                         RecyclerView.Adapter adapter, int column) {
    ...
    public static void initRecyclerViewGH(Context context, RecyclerView view, RecyclerView.Adapter adapter, int column) {
        initRecyclerViewG(context, view, false, adapter, column);
    }
